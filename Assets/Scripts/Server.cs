...
public class Server : MonoBehaviour
{
    ...
    //static string GameIP = Dns.GetHostEntry(Dns.GetHostName()).AddressList[Dns.GetHostEntry(Dns.GetHostName()).AddressList.Length - 1].ToString();

    public TextMeshProUGUI ipAdress;
